...
from brain.intent import Intent, PRIVATE_ONLY_INTENTS, GROUP_ALLOWED_INTENTS
...
async def process(ctx: BrainContext, bot: Any) -> None:
    ...
    from onboarding.fsm_middleware import handle_fsm
    ...
    if is_new or user.assistant_name == "Ассистент":
        from onboarding.flow import start_onboarding
