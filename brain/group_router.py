...
from brain.intent import Intent, GROUP_ALLOWED_INTENTS
from brain.classifier import classify
from brain.context import BrainContext
from brain.router import process as private_process, _handlers
from auth.identity import get_or_create_user
from safety import check_user_access
from safety.group_moderation import ensure_group_exists
from i18n import t
...
async def process_group_message(ctx: BrainContext, bot) -> None:
    ...
    if handler:
        try:
            ...
            from monitoring.metrics import capture_exception
