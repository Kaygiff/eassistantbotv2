...
class TestCircuitBreaker:
    ...
    def test_initially_closed(self):
        from services.ai_provider.hub import CircuitBreaker
        cb = CircuitBreaker("test")
        assert cb.is_open() is False

    def test_opens_after_threshold(self):
        from services.ai_provider.hub import CircuitBreaker, CIRCUIT_BREAKER_THRESHOLD
        cb = CircuitBreaker("test")
...
class TestAIHub:
    ...
    async def test_hub_uses_first_available(self):
        from services.ai_provider.hub import AIProviderHub
    ...
    async def test_hub_skips_open_circuit(self):
        from services.ai_provider.hub import AIProviderHub, CIRCUIT_BREAKER_THRESHOLD
