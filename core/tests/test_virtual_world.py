...
class TestRelationships:
    ...
    def test_ordered_pair_consistency(self):
        from world.virtual_world.relationships.service import _ordered_pair
...
class TestActions:
    ...
    def test_detect_hug(self):
        from world.virtual_world.actions.service import _detect_action
    ...
    async def test_cooldown_blocks_repeat(self, fake_redis):
        with patch("virtual_world.actions.service.get_redis", return_value=fake_redis):
            from world.virtual_world.actions.service import _check_cooldown, _set_cooldown
...
class TestBlacklist:
    ...
    async def test_is_blocked_true(self, mock_supabase):
        ...
        from world.virtual_world.blacklist.service import is_blocked
