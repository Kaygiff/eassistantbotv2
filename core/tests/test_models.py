...
class TestPetModel:
    ...
    def test_valid_pet(self):
        from core.models.pets import Pet
        pet = Pet(
            id=uuid4(),
            user_id=uuid4(),
            name="Барсик",
    ...
    def test_pet_hunger_bounds(self):
        from core.models.pets import PetUpdate
        import pydantic
...
class TestEcoinTransaction:
    ...
    def test_valid_transaction(self):
        from core.models.economy import EcoinTransactionCreate
...
class TestTaskModel:
    ...
    def test_valid_task(self):
        from core.models.tasks import TaskCreate
        task = TaskCreate(
            user_id=uuid4(),
            type="todo",
            title="Купить молоко",
