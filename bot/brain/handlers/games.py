...
async def handle_quiz(ctx: BrainContext, bot) -> None:
    from world.casino.games.quiz import start_quiz
...
async def handle_truth_dare(ctx: BrainContext, bot) -> None:
    from world.casino.games.truth_dare import get_truth_dare
...
async def handle_would_you(ctx: BrainContext, bot) -> None:
    from world.casino.games.would_you import get_would_you
...
async def handle_riddle(ctx: BrainContext, bot) -> None:
    from world.casino.games.riddle import get_riddle
